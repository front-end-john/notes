...
public class HomeController {
     ...
     */
    private String appId = ""; // https://cloud.baidu.com 应用管理获取 AppID
    private String apiKey = "";// https://cloud.baidu.com 应用管理获取 API Key
    private String secretKey = ""; // https://cloud.baidu.com 应用管理获取 Secret Key
